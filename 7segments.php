<?php
/*
Plugin Name: 7SEGMENTS Analytics for WordPress 
Plugin URI: https://www.7segments.io/docs/wordpress
Description: Track your visitors with 7SEGMENTS Analytics.
Version: 0.0.1
Author: 7SEGMENTS
*/
...
class Segment_Analytics_WordPress {
	...
	public function admin_menu() {
		...
		add_options_page(
			apply_filters( 'segment_admin_menu_page_title', __( '7SEGMENTS', 'segment' ) ), // Page Title
			apply_filters( 'segment_admin_menu_menu_title', __( '7SEGMENTS', 'segment' ) ), // Menu Title
