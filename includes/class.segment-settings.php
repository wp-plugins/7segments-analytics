...
class Segment_Settings {
	...
	public static function general_section_callback() {
		?>
		<p style="max-width: 50em"><?php _e( '7SEGMENTS is Big Data Analytics solution. Register for free on <a href="http://portal.7segments.com">www.7Segments.com</a> to get access.', 'segment' ); ?></p>
		<?php
	}
	...
	?>
			...
			<p class="description"><?php _e( 'You can find your API Write Key in <a href="https://portal.7segments.com/#/getting-started/blank-company/web">Getting Started Guide</a>.', 'segment' ); ?></p>
		<?php
